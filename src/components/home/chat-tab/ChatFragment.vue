...
function switchToContactsFragment() {
    viewStore.fetchContactsFragment();
}
        ...
        <ion-header>
            <ion-toolbar>
                ...
                <ion-buttons slot="start">
                    <ion-button @click="switchToContactsFragment">
                        <ion-icon :icon="arrowBack" class="back-icon"/>
                    </ion-button>
                </ion-buttons>
        ...
        <ion-footer>
            <ion-toolbar>
                <ion-item>
                    ...
                    <ion-button fill="clear" @touchstart="startRecording" @touchend="stopRecording"
